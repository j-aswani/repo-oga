...
from authserver.utils.jws import get_jws_info
...
class TokenTestCase(BasicTestCase):
    ...
    def get_jwt_data(cls, jwt, validator):
        ...
        token_data = get_jws_info(jwstoken, signature_key, settings.AUTHSERVER_ISSUER, [APPLICATION['_id']], validator).payload
        return token_data
